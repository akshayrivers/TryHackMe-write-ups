...
An Nmap usually goes through these steps to scan ,although many of this is optional and can be controlled through caommand line arguments

![image.png](Nmap%20Live%20Host%20Discovery%2021c2dcee5172806791c2d2c611c79b93/image.png)
...
![](https://tryhackme-images.s3.amazonaws.com/user-uploads/5f04259cf9bf5b57aed2c476/room-content/818d1c5a3a96a9962dde71069f9e1ee8.png)
...
it is simple really - 256*25 = 6400
...
In this case, the AttackBox had the IP address 10.10.210.6, and it used ARP requests to discover the live hosts on the same subnet. ARP scan works, as shown in the figure below. Nmapsends ARP requests to all the target computers, and those online should send an ARP reply back.
...
3 → only the devices on the subnet and the router replied 
...
Finally, we can use UDP to discover if the host is online. Contrary to TCP SYN ping, sending a UDP packet to an open port is not expected to lead to any reply. However, if we send a UDPpacket to a closed UDP port, we expect to get an ICMP port unreachable packet; this indicates that the target system is up and available.
...
You have learned how ARP, ICMP, TCP, and UDP can detect live hosts by completing this room. Any response from a host is an indication that it is online. Below is a quick summary of the command-line options for Nmap that we have covered. ## -sn means thatnmap shol
